import { attachOrderResponseArtwork, createInternalOrder, createPaidOrder, uploadArtworkFile, listCustomerOrders, getCustomerOrder, setCustomerEmail, getCustomerEmail, customerOrderDocumentUrl, openCustomerOrderDocument, getArtworkReuploadContext, submitReplacementArtwork, confirmCardPayment } from './services/internalStorefront';
...
export const payment = { async update(data = {}) { return call('payment.update', () => storefront().payment?.update?.(data), null); }, async confirmCard(sessionId) { return confirmCardPayment(sessionId); } };
...
export { submitReplacementArtwork, confirmCardPayment };
